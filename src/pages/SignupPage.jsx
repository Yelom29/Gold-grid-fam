...
function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://094h0r7hl5.execute-api.us-east-1.amazonaws.com/API_deploy/register', formData); // replace with your  signup  api endpoint
